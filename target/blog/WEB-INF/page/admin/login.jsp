    ...
    <div class="main-cont-wrap login-model">
        <form id="login">
            ...
            <div class="form-item">
                ...
                <input type="text" class="form-input original" id="login_name" name="login_name" placeholder="请输入账号" data-type="必填" error-pos="32" />
            </div>
            <div class="form-item">
                <span class="form-txt">密码：</span>
                <input type="passWord" class="form-input original" name="pass_word" placeholder="请输入密码" data-type="必填" error-pos="32" />
            </div>
            <div class="form-btn">
